...
function acheterTicket() {
    ...
    let tripId = parseInt(prompt("ID du trajet : "));
    ...
    while (tickets.find(function(ticket) {
        return ticket.tripId === trip.id && ticket.seatNumber === seatNumber;
})) {
        seatNumber++;
}
    let ticket = {
